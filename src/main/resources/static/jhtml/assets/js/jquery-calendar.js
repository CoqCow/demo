...
(function ($) {
    ...
    $.fn.dynDateTime = function (options) {
        ...
        $.fn.dynDateTime.defaults = {
            ...
            onClose: null,
            onUpdate: null,
            onOpen: null,//upd by wangsiyuan6
            date: null,
            showsTime: false,
            timeFormat: "24",
            electric: true,
...
Calendar = function (firstDayOfWeek, dateStr, onSelected, onClose, onOpen) {
    // member variables
    this.activeDiv = null;
    ...
    for (var i = 0; i < 6; ++i, row = row.nextSibling) {
        ...
        for (var j = 0; j < 7; ++j, cell = cell.nextSibling, date.setDate(iday + 1)) {
            ...
            if (this.getDateStatus) {
                ...
                if (status === true) {
                    cell.className += " calendardisabled";//更改disabled
                    cell.disabled = true;
                } else {
...
Calendar.prototype.hide = function () {
    ...
    this.hidden = true;
    this.hideShowCovered();
    if(this.element.parentNode) //2012/1/16 选择当日事bug
...
Date.prototype.print = function (str) {
    ...
    s["%$"] = (d<7&&wn>1)?((y-1)+ " "+wn):(  (m==11&&wn==1)?((y+1)+ " "+wn):(y+ " "+wn)  );
    //s["%$"] = (d<7&&wn>1)?((y-1)+ " "+wn):(y+ " "+wn);
    var re = /%./g;
